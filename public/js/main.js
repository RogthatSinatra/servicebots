...
$(function () {
    ...
    var unit = 'metric';
    var lastData = {};
    var weatherApiKey = 'fd7c9487c37044a4608cf337d1fc0fc0';
...
if(hours > 6 && hours < 20) {
    document.getElementById("hideday").style.visibility = "visible";
   } else{
    document.getElementById("hidenight").style.visibility = "visible";
}
